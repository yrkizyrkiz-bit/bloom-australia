...
const services = [
  {
    ...
    image: "/images/remote/same-assets/1389255586-2658080352.webp",
    icon: Scale,
  ...
  },
  {
    id: "hair-loss",
    title: "Hair Loss",
    description: "Doctor-led hair health programs with assessment and ongoing clinical support",
    longDescription: "Personalised hair health care prescribed by Australian doctors after a comprehensive health assessment. Treatment options are discussed privately if clinically appropriate.",
    image: "/images/remote/same-assets/1389255586-3446480003.webp",
    icon: Sparkles,
  ...
  },
  {
    ...
    description: "Doctor-led perimenopause and menopause care",
    longDescription: "Confidential menopause and perimenopause assessment with Australian doctors, biomarker-informed review, and personalised care planning if clinically appropriate.",
    image: "/images/remote/same-assets/1389255586-754957936.webp",
    icon: Heart,
    color: "from-[#c17a58] to-[#a9634a]",
    features: ["Menopause Care", "Symptom Assessment", "Hormone Support", "Ongoing Support"],
    price: "From $89/month",
    requiresBiomarker: true,
  },
  {
    id: "mens-health",
    title: "Men's Health",
    description: "Doctor-led men's health assessment and care planning",
    longDescription: "Evidence-based men's health programs focusing on hormone health, energy levels, and overall vitality. Care options are discussed privately after doctor assessment.",
    image: "/images/remote/same-assets/1389255586-2770872326.webp",
    icon: UserCircle,
    color: "from-[#34412f] to-[#2c3628]",
    features: ["Hormone assessment", "Energy support", "Clinical monitoring", "Preventive care"],
    price: "From $99/month",
    requiresBiomarker: true,
  },
];
