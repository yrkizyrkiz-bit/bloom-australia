...
const faqs = [
  ...
  {
    question: "Where shall I start?",
    answer: (
      <>
        Start with our confidential{" "}
        <Link
          href="/mens-health/assessment?concern=erectile-dysfunction"
          className="underline text-[#5c7a52] hover:text-[#2c3628] font-medium"
        >
          online assessment
        </Link>
        , then order the{" "}
        <Link
          href="/biomarkers/checkout?package=advanced"
          className="underline text-[#5c7a52] hover:text-[#2c3628] font-medium"
        >
          Biomarkers Advanced Panel
        </Link>
        . The Advanced Panel includes a doctor consultation so your results and next steps are
        reviewed with an AHPRA-registered Australian doctor.
      </>
    ),
  },
];
  ...
  return (
    <div className="min-h-screen bg-[#fdfbf7]">
      ...
      <main>
            ...
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              ...
              <div className="relative">
                <div className="relative aspect-[4/3] lg:aspect-square rounded-3xl overflow-hidden shadow-xl">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#34412f]/35 to-transparent" />
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Sticky section nav */}
        <nav className="sticky top-0 z-20 bg-[#fdfbf7]/95 backdrop-blur border-b border-[#e6ebe3]">
            ...
            <div className="flex gap-2 min-w-max">
              {sectionNav.map((item) => (
                <a
                  key={item.id}
                  href={`#${item.id}`}
                  className="px-4 py-2 text-sm font-medium text-[#5c7a52] hover:text-[#2c3628] hover:bg-[#e6ebe3]/70 rounded-full transition-colors whitespace-nowrap"
                >
                  {item.label}
                </a>
              ))}
        ...
        {/* Medical disclaimer — early visibility */}
        <div className="bg-[#f4f7f2] py-3 border-b border-[#e6ebe3]">
          <p className="text-xs text-[#5c7a52] max-w-4xl mx-auto px-4 text-center leading-relaxed">
            <strong className="text-[#2c3628]">Medical disclaimer:</strong> This page provides general
            health information only and is not a substitute for professional medical advice, diagnosis,
            or individual clinical care.{" "}
            <Link href={LEGAL_LINKS.medicalDisclaimer} className="underline text-[#5c7a52] hover:text-[#2c3628]">
        ...
        {/* Symptoms */}
        <section id="symptoms" className="py-20 lg:py-28 bg-[#f4f7f2] scroll-mt-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Causes */}
        <section id="causes" className="py-20 lg:py-28 scroll-mt-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Risk factors */}
        <section id="risk-factors" className="py-20 lg:py-28 bg-[#34412f] scroll-mt-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section id="diagnosis" className="py-20 lg:py-28 scroll-mt-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14 max-w-3xl mx-auto">
              <span className="inline-block px-4 py-1.5 text-sm font-medium bg-[#e6ebe3] text-[#5c7a52] rounded-full mb-4">
                Assessment
        ...
        <section id="care" className="py-20 lg:py-28 bg-[#f4f7f2] scroll-mt-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14 max-w-3xl mx-auto">
              <span className="inline-block px-4 py-1.5 text-sm font-medium bg-[#5c7a52]/15 text-[#5c7a52] rounded-full mb-4">
                Care at Sanative
        ...
        {/* Prevention */}
        <section id="prevention" className="py-20 lg:py-28 scroll-mt-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              <div>
                <span className="inline-block px-4 py-1.5 text-sm font-medium bg-[#e6ebe3] text-[#5c7a52] rounded-full mb-4">
        ...
        {/* FAQ */}
        <section id="faq" className="py-20 lg:py-28 bg-[#f4f7f2] scroll-mt-16">
        ...
        <section className="py-16 bg-[#fdfbf7]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl font-serif text-[#2c3628] mb-8 text-center">Related pathways</h2>
            <div className="grid md:grid-cols-3 gap-6">
              <Link
                href="/mens-health/sexual-health"
                className="group bg-white rounded-2xl p-6 border border-[#e6ebe3] hover:shadow-lg transition-shadow"
              >
                <h3 className="text-lg font-serif text-[#2c3628] mb-2 group-hover:text-[#5c7a52]">
                  Men&apos;s sexual health
                </h3>
                <p className="text-sm text-[#5c7a52]">
                  Broader doctor-led assessment for sexual wellbeing concerns.
                </p>
              </Link>
              <Link
                href="/mens-health#energy"
                className="group bg-white rounded-2xl p-6 border border-[#e6ebe3] hover:shadow-lg transition-shadow"
              >
                <h3 className="text-lg font-serif text-[#2c3628] mb-2 group-hover:text-[#5c7a52]">
                  Energy & vitality
                ...
                <p className="text-sm text-[#5c7a52]">
                  Fatigue, recovery, and metabolic factors that can overlap with sexual health.
                </p>
              </Link>
              <Link
              ...
              >
                ...
                <p className="text-sm text-[#5c7a52]">
                  From sample to action plan — how blood testing informs care.
                </p>
              </Link>
            </div>
          </div>
        ...
        <section className="py-20 lg:py-28 bg-[#34412f]">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg text-[#a8bb9e] mb-10 max-w-2xl mx-auto">
              Complete a health assessment and book a doctor consultation. Your Sanative doctor
