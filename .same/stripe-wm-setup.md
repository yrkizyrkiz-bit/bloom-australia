...
STRIPE_WM_CORE_QUARTERLY_PRICE_ID=price_xxxxxxxxxxxxxxxx
STRIPE_WM_CORE_BIANNUAL_PRICE_ID=price_xxxxxxxxxxxxxxxx
...
STRIPE_WM_PRECISION_QUARTERLY_PRICE_ID=price_xxxxxxxxxxxxxxxx
STRIPE_WM_PRECISION_BIANNUAL_PRICE_ID=price_xxxxxxxxxxxxxxxx
```

**Cadence prices (for quarterly / 6-month upsells):**

| Product | Interval | Suggested AUD | Env var |
|---------|----------|---------------|---------|
| Sanative Core | Quarterly | $990 | `STRIPE_WM_CORE_QUARTERLY_PRICE_ID` |
| Sanative Core | 6-month | $1,890 | `STRIPE_WM_CORE_BIANNUAL_PRICE_ID` |
| Sanative Precision | Quarterly | $1,410 | `STRIPE_WM_PRECISION_QUARTERLY_PRICE_ID` |
| Sanative Precision | 6-month | $2,690 | `STRIPE_WM_PRECISION_BIANNUAL_PRICE_ID` |

Create these as recurring prices in Stripe (3-month and 6-month billing periods), then run `bun run prisma/seed.ts` to sync the catalog.
